  ...
  <div class="page">
    ...
    <template v-else-if="profile">
      ...
      <section class="profile-grid">
        <article class="card stack">
          ...
          <div class="quick-links">
            <router-link to="/chat" class="quick-link feature-link"><strong>AI 学习助手</strong><span>围绕算法问题、历史提交和题目标签进行连续对话与练习推荐。</span></router-link>
        ...
        <article class="card stack">
          ...
          <div v-else class="empty-state compact-state"><strong>还没有 AC 记录</strong><span class="muted">先完成几道题，再通过 AI 学习助手获得更有针对性的分析和练习建议。</span></div>
        </article>
      </section>
      ...
      <section v-if="store.isAdmin" class="admin-panel">
        <div><span class="eyebrow">Admin Console</span><h2>管理工作区</h2><p>管理员可以在这里进入用户封禁、题目、标签和新建题目等运营入口。</p></div>
        <div class="cluster">
    ...
    <section v-else class="empty-state"><strong>没有拿到个人信息</strong><span class="muted">可以重新登录后再试一次。</span></section>
  </div>
</template>
<script setup>
